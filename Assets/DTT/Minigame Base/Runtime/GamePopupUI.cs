...
namespace DTT.MinigameBase.UI
{
    ...
    public class GamePopupUI : MonoBehaviour
    {
        ...
        public event Action DismissButtonPressed;
        ...
        /// </summary>
        //[SerializeField]
        //private TMP_Text _titleBackdropText;
        ...
        /// <summary>
        /// The button to dismiss pop up modal.
        /// </summary>
        [SerializeField]
        ...
        /// Called when the home button is pressed.
        /// </summary>
        private void OnDismissButtonClicked() => ResumeButtonPressed?.Invoke();
        ...
        /// </summary>
        /// <param name="isEnabled">Whether to enable or disable</param>
        public void EnableDismissButton(bool isEnabled) => _dismissButton.gameObject.SetActive(isEnabled);
