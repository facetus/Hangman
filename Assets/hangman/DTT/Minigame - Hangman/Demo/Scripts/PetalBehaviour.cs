...
namespace Enneas.Hangman.DTT.Hangman.Demo
{
    ...
    public class PetalBehaviour : ScenarioPartBehaviour
    {
        ...
        /// </summary>
        public override bool Unlocked => !_dropping && Vector3.Distance(transform.position, _droppedPosition) < 0.1f;

        /// <summary>
        /// Whether the petal is currently dropping.
        /// </summary>
        public override bool Unlocking => _dropping;
        ...
        public override void Unlock(HangmanService service)
        {
            ...
            if (_renderer) _renderer.sortingOrder = RandomExtensions.FiftyFifty() ? 1 : 3;
